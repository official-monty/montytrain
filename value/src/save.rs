...
pub struct SavedNetworkFormat {
    pub wq: [[Accumulator<{DK as usize}>; 256]; TOKENS as usize],
    pub wk: [[Accumulator<{DK as usize}>; 256]; TOKENS as usize],
    pub wv: [[Accumulator<{DV as usize}>; 256]; TOKENS as usize],
